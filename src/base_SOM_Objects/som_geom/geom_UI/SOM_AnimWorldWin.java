...
//		this.mapMgr = (SOM_GeomMapManager) somUIWin.mapMgr;
	...
	public final void initAllPrivBtns() {
		...
		//tmpBtnNamesArray.add(new Object[] {"Showing SOM Map UI","Show SOM Map UI",drawSOM_MapUIVis});
...
//		somUIWin.setRtSideUIBoxClrs(new int[]{0,0,0,200},new int[]{255,255,255,255});
	 ...
	 */
	@Override
	protected boolean checkClsBox(int mouseX, int mouseY){return false;}
	/**
...
//		}
		if(res) {return res;}
		//handleMouseDrag(int mouseX, int mouseY,int pmouseX, int pmouseY, myVector mseDragInWorld, int mseBtn)
		if((this.somUIWin != null) && (getPrivFlags(drawSOM_MapUIVis))) {
