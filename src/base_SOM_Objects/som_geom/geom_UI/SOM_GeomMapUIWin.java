...
public class SOM_GeomMapUIWin extends SOM_MapUIWin {
    ...
    protected boolean hndlMouseClick_Indiv(int mouseX, int mouseY, int mseBtn) {
        ...
        if(uiMgr.getPrivFlag(mapDataLoadedIDX)){ 
            ...
            mod = this.checkMouseClick(mouseX, mouseY, mseBtn);
        }
//        if(mod) {return mod;}
//        else {return checkUIButtons(mouseX, mouseY);}
    ...
    protected boolean hndlMouseDrag_Indiv(int mouseX, int mouseY, int pmouseX, int pmouseY, int mseBtn) {
        ...
        if(uiMgr.getPrivFlag(mapDataLoadedIDX)){ 
            ...
            mod = this.checkMouseDragMove(mouseX, mouseY, pmouseX, pmouseY, mseBtn);
        }        
        return mod;
    }
    @Override
    ...
    @Override
    public String toString(){        String res = super.toString();        return res;    }

    @Override
    protected String getCategoryUIObjLabel() {        return null;    }

    @Override
    protected String getClassUIObjLabel() {        return null;    }

    @Override
    protected void setPrivFlags_LockCatForClassSegs(boolean val) {}

    @Override
    protected int getCategoryFromClass(int _curCatIDX, int _classIDX) {        return 0;    }

    @Override
    protected int getClassFromCategory(int _catIDX, int _curClassIDX) {        return 0;    }

    @Override
    protected int getClassLabelFromIDX(int _idx) {        return 0;    }

    @Override
    protected int getCategoryLabelFromIDX(int _idx) {        return 0;    }
